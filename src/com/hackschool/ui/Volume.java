...
import com.hackschool.mol.ui.molGas;
import com.hackschool.volume.ui.volCM;
...
public class Volume extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        optionVolume = new javax.swing.JComboBox<>();
        ...
        getContentPane().add(header, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 400, 94));
        ...
        optionVolume.setFont(new java.awt.Font("Nanum Gothic", 1, 14)); // NOI18N
        optionVolume.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Mol, Concentration", "Mol of Gas at rtp" }));
        optionVolume.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                optionVolumeActionPerformed(evt);
            }
        });
        mainPanel2.add(optionVolume, new org.netbeans.lib.awtextra.AbsoluteConstraints(175, 150, 200, 30));
        ...
        getContentPane().add(mainPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 100, 400, 515));
    ...
    private void optionVolumeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_optionVolumeActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_optionVolumeActionPerformed
    ...
    private void enterButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_enterButton2ActionPerformed
        // TODO add your handling code here:
        String option = optionVolume.getSelectedItem().toString();

        if (option.equals("Mol, Concentration")) {
            volCM goCM = new volCM();
            goCM.setVisible(true);
            this.setVisible(false);
            this.dispose();
        }
        
        if (option.equals("Mol of Gas at rtp")) {
            molGas goMol = new molGas();
    ...
    private javax.swing.JComboBox<String> optionVolume;
