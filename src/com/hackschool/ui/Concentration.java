...
import com.hackschool.concentration.ui.conMV;
 ...
 * @author teohzinean
 */
public class Concentration extends javax.swing.JFrame {

    /**
     * Creates new form Concentration
     */
    ...
    private void initComponents() {
        ...
        optionConcentration = new javax.swing.JComboBox<>();
        ...
        optionConcentration.setFont(new java.awt.Font("Nanum Gothic", 1, 14)); // NOI18N
        optionConcentration.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Mol, Volume" }));
        optionConcentration.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                optionConcentrationActionPerformed(evt);
            }
        });
        mainPanel2.add(optionConcentration, new org.netbeans.lib.awtextra.AbsoluteConstraints(175, 150, 200, 30));
        ...
        calculate3.setText("Concentration");
    ...
    private void optionConcentrationActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_optionConcentrationActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_optionConcentrationActionPerformed
    ...
    private void enterButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_enterButton2ActionPerformed
        // TODO add your handling code here:
        String option = optionConcentration.getSelectedItem().toString();

        if (option.equals("Mol, Volume")) {
            conMV goMV = new conMV();
            goMV.setVisible(true);
            this.setVisible(false);
            this.dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Concentration.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Concentration().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JComboBox<String> optionConcentration;
