...
import com.hackschool.purity.ui.purityPercent;
 ...
 * @author teohzinean
 */
public class Purity extends javax.swing.JFrame {

    /**
     * Creates new form Purity
     */
    public Purity() {
        initComponents();
    ...
    private void initComponents() {
        ...
        optionYield.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Pure & Impure Mass" }));
        ...
        calculate3.setText("Purity");
        mainPanel2.add(calculate3, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 60, 300, 35));

        getContentPane().add(mainPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 100, 390, 515));
    ...
    private void enterButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_enterButton2ActionPerformed
        ...
        if (option.equals("Pure & Impure Mass")) {
            purityPercent goPurity = new purityPercent();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Purity.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
