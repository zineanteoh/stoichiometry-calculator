 ...
 */
package com.hackschool.yield.ui;

import com.hackschool.ui.Yield;
 ...
 * @author teohzinean
 */
public class yieldPercent extends javax.swing.JFrame {

    /**
     * Creates new form yieldPercent
     */
    public yieldPercent() {
        initComponents();
    ...
    private void initComponents() {
        ...
        omTextField = new javax.swing.JTextField();
        calculate7 = new javax.swing.JLabel();
        amTextField = new javax.swing.JTextField();
        ...
        calculate4.setText("Actual Mass : ");
        mainPanel2.add(calculate4, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 255, 200, 35));

        omTextField.setFont(new java.awt.Font("Lucida Grande", 1, 24)); // NOI18N
        omTextField.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        omTextField.addPropertyChangeListener(new java.beans.PropertyChangeListener() {
            public void propertyChange(java.beans.PropertyChangeEvent evt) {
                omTextFieldPropertyChange(evt);
            }
        });
        mainPanel2.add(omTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 180, 150, 42));
        ...
        calculate7.setText("Obtained Mass : ");
        mainPanel2.add(calculate7, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 180, 200, 35));

        amTextField.setFont(new java.awt.Font("Lucida Grande", 1, 24)); // NOI18N
        amTextField.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        mainPanel2.add(amTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 250, 150, 42));
        ...
        calculate5.setText("With Obtained & Actual Mass");
        ...
        calculate3.setText("Yield Percentage");
        ...
        calculate10.setFont(new java.awt.Font("Nanum Gothic", 1, 14)); // NOI18N
        calculate10.setForeground(new java.awt.Color(255, 255, 255));
        calculate10.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        calculate10.setText("(Theoretical Mass)");
        mainPanel2.add(calculate10, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 280, 150, 35));
    ...
    private void enterButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_enterButtonActionPerformed
        ...
        if(omTextField.getText().matches(".*\\d.*") && amTextField.getText().matches(".*\\d.*")) {
            Float om = Float.parseFloat(omTextField.getText());
            Float am = Float.parseFloat(amTextField.getText());
            
            Float yield = (om/am) * 100;

            JOptionPane.showMessageDialog(this, "= " + yield + "%");
    ...
    private void omTextFieldPropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_omTextFieldPropertyChange
        // TODO add your handling code here:
    }//GEN-LAST:event_omTextFieldPropertyChange
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(yieldPercent.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new yieldPercent().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField amTextField;
    ...
    private javax.swing.JTextField omTextField;
