 ...
 */
package com.hackschool.concentration.ui;

import com.hackschool.ui.Concentration;
 ...
 * @author teohzinean
 */
public class conMV extends javax.swing.JFrame {

    /**
     * Creates new form conMV
     */
    public conMV() {
        initComponents();
    ...
    private void initComponents() {
        ...
        mainPanel2.add(enterButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(149, 336, 86, 42));
        ...
        calculate4.setText("Mol : ");
        mainPanel2.add(calculate4, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 185, 150, 30));
        ...
        mainPanel2.add(mTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(134, 177, 150, 42));
        ...
        mainPanel2.add(calculate7, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 259, 102, -1));
        ...
        mainPanel2.add(vTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(134, 252, 150, 42));
        ...
        calculate5.setText("With Mol, Volume");
        mainPanel2.add(calculate5, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 120, 300, 35));
        ...
        mainPanel2.add(calculate8, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 185, 50, 30));
        calculate8.getAccessibleContext().setAccessibleDescription("");
        ...
        mainPanel2.add(volUnit, new org.netbeans.lib.awtextra.AbsoluteConstraints(295, 261, -1, -1));
    ...
    private void enterButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_enterButtonActionPerformed
        ...
        if(mTextField.getText().matches(".*\\d.*") && vTextField.getText().matches(".*\\d.*")) {
            Float mol = Float.parseFloat(mTextField.getText());
            ...
            JOptionPane.showMessageDialog(this, "= " + con + "mol/dm^3");
    ...
    private void backActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_backActionPerformed
        // TODO add your handling code here:
        Concentration goCon = new Concentration();
        goCon.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(conMV.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
